...
export const APIGatewayProxyEventFactory = factory<APIGatewayProxyEvent>(
  (fake) => {
    ...
    const headers = {
      ...
      Via: '1.1 d6e11dc2ec6f45889d724685e5a0e931.cloudfront.net (CloudFront)',
      'X-Amz-Cf-Id': '-ue8unqCkJ0KZAsgTmaJGoWWqgSpaVCvQzTbrUDPDWWccW_J6zND2w==',
      'X-Amzn-Trace-Id': 'Root=1-5ed2e0c0-8a120e646e67323c73053ea3',
    ...
    return {
      ...
      requestContext: {
        ...
        resourcePath: path,
        httpMethod,
        extendedRequestId: 'NXgODF1poAMF9Xg=',
        ...
        stage,
        domainPrefix: apiId,
        requestTimeEpoch: 1590878400202,
