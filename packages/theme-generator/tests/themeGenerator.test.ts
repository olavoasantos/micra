...
describe('themeGenerator tests', () => {
  const theme: JSOSParserDefinition = {
    ...
    backgroundColors: ({ get, rgba, value }) => ({
      root: get('root'),
  ...
  it('should generate generic theme object', () => {
    ...
    expect(content).toBe(
      '{"root":string;"colors":{"black":string;"red":string;"green":string;"blue":string;};"opacity":{"10":string;};"fontFamily":{"serif":string;};"textColors":{"black":string;"red":string;"green":string;"blue":string;};"backgroundColors":{"root":string;"value":string;"black":string;"whiteOverlay":string;"overlay":string;};}',
    );
  });
  ...
  it('should generate a theme object', () => {
    ...
    expect(content).toBe(
      '{"root":"val","colors":{"black":"#000","red":"#f00","green":"#0f0","blue":"#00f",},"opacity":{"10":"0.1",},"fontFamily":{"serif":"Georgia, serif",},"textColors":{"black":"#000","red":"#f00","green":"#0f0","blue":"#00f",},"backgroundColors":{"root":"val","value":"#f00","black":"#000","whiteOverlay":"rgba(#fff, 0.5)","overlay":"rgba(#000, 0.5)",},}',
    );
  });
